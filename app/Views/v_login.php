    ...
    <div class="container-login100" style="background-image: url('<?= base_url("bg-login.jpeg"); ?>');">
        <div class="wrap-login100 p-t-190 p-b-30">
            <form id="frmLogin" action="<?= base_url('login/auth'); ?>" method="post" class="login100-form validate-form">
                ...
                <small class="p-b-20 ml-4 text-white mt-2">Sistem Informasi dan Administrasi Perumahan</small>
                    ...
                    <div class="col-md-12" >
                        <div class="form-check checkbox">
                            <label class="form-check-label text-white" for="x_show">
                                <input class="form-check-input mr-2" name="x_show" id="x_show" type="checkbox" value="1"/><small>Tampilkan password</small></label>
                        </div>
                        <div class="form-check checkbox">
                            <label class="form-check-label text-white" for="x_rmbr">
                                <input class="form-check-input mr-2" name="x_rmbr" id="x_rmbr" type="checkbox" value="1"/> <small>Selalu ingat saya</small></label>
                        </div>
                    </div>
                </div>
